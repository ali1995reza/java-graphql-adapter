...
import grphaqladapter.adaptedschema.mapping.mapper.classes.*;
import grphaqladapter.adaptedschema.mapping.strategy.descriptors.annotations.AnnotationBaseDirectiveDescriptor;
import grphaqladapter.adaptedschema.mapping.strategy.descriptors.annotations.AppliedDirectiveDescriptor;
import grphaqladapter.adaptedschema.mapping.strategy.descriptors.classes.AnnotationBaseClassDescriptor;
import grphaqladapter.adaptedschema.mapping.strategy.descriptors.classes.ClassDescriptor;
import grphaqladapter.adaptedschema.mapping.strategy.descriptors.field.AnnotationBaseEnumConstantDescriptor;
import grphaqladapter.adaptedschema.mapping.strategy.descriptors.field.AutomaticEnumConstantDescriptor;
import grphaqladapter.adaptedschema.mapping.strategy.descriptors.field.EnumConstantDescriptor;
import grphaqladapter.adaptedschema.mapping.strategy.descriptors.method.AnnotationBaseMethodDescriptor;
import grphaqladapter.adaptedschema.mapping.strategy.descriptors.method.MethodDescriptor;
import grphaqladapter.adaptedschema.mapping.strategy.descriptors.method.PojoMethodDescriptor;
import grphaqladapter.adaptedschema.mapping.strategy.descriptors.parameter.AnnotationBaseParameterDescriptor;
...
public final class ClassMapper {
    ...
    public List<MappedClass> mapClass(Class clazz, Map<Class, MappedAnnotation> annotations, ObjectConstructor constructor, ObjectBuilder builder) {
        if (clazz.isEnum()) {
            return mapEnumClass(clazz, annotations, constructor, builder);
        }
        if (clazz.isAnnotation()) {
            return mapAnnotationClass(clazz, annotations, constructor, builder);
        }
