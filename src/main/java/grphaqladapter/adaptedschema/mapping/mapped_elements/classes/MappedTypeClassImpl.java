...
final class MappedTypeClassImpl extends MappedClassImpl implements MappedObjectTypeClass {

    private final Map<String, MappedFieldMethod> fieldMethods;

    MappedTypeClassImpl(String name, MappedElementType elementType, String description, List<AppliedAnnotation> appliedAnnotations, Class baseClass, Map<String, MappedFieldMethod> fieldMethods) {
