...
final class MappedUnionInterfaceImpl extends MappedClassImpl implements MappedUnionInterface {
    ...
    MappedUnionInterfaceImpl(String name, String description, List<AppliedAnnotation> appliedAnnotations, Class baseClass) {
        super(name, MappedElementType.UNION, description, appliedAnnotations, baseClass);
    }
}
