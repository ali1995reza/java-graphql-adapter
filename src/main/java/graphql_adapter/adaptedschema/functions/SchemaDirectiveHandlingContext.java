...
public interface SchemaDirectiveHandlingContext {
    ...
    SchemaDirectiveHandlingContext changeDataFetcherBehavior(String parent, String field, Function<AdaptedGraphQLDataFetcher<?>, AdaptedGraphQLDataFetcher<?>> function);
