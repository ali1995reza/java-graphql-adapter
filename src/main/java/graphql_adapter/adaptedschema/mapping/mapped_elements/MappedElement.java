...
public interface MappedElement {
    ...
    List<AppliedAnnotation> appliedAnnotations();

    Map<Class<? extends Annotation>, AppliedAnnotation> appliedAnnotationsByClass();

    Map<String, AppliedAnnotation> appliedAnnotationsByName();
