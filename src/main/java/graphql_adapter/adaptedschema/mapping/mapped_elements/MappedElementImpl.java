...
public class MappedElementImpl implements MappedElement {
    ...
    private final Map<Class<? extends Annotation>, AppliedAnnotation> appliedAnnotationsByClass;
    ...
    @Override
    public Map<Class<? extends Annotation>, AppliedAnnotation> appliedAnnotationsByClass() {
