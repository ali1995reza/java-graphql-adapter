...
public class CustomIntValueParser implements ValueParser<String, Integer> {
    @Override
    public Integer parse(String input, TypeInformation<?> descriptor, ValueParsingContext context) {
        return 10;
    }
}
