...
public class CustomBooleanValueParser implements ValueParser<String, Boolean> {
    @Override
    public Boolean parse(String input, TypeInformation<?> descriptor, ValueParsingContext context) {
        return false;
    }
}
