...
public class CustomStringValueParser implements ValueParser<String, String> {
    @Override
    public String parse(String input, TypeInformation<?> descriptor, ValueParsingContext context) {
        return "DV1";
    }
}
